...
class ListTileNativeAdFactoryNight(val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = LayoutInflater.from(context)
                .inflate(R.layout.normal_native_ad_night, null) as NativeAdView
