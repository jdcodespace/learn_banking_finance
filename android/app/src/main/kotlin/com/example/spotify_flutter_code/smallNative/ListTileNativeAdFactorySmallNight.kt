package com.example.spotify_flutter_code.smallNative
...
class ListTileNativeAdFactorySmallNight(val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = LayoutInflater.from(context)
                .inflate(R.layout.native_medium_ad_night, null) as NativeAdView

        with(nativeAdView) {
            val body = nativeAd.body
            var tertiaryView: TextView? = null
            tertiaryView = findViewById<View>(R.id.body_small) as TextView
            tertiaryView.text = body
            nativeAdView.bodyView = tertiaryView

            var callToActionView: Button? = null
            callToActionView = findViewById<View>(R.id.cta_small) as Button
...
//            nativeAdView.mediaView = mediaView
            ...
            secondaryView = findViewById<View>(R.id.secondary_small) as TextView
            ...
            primaryView = findViewById<View>(R.id.primary_small) as TextView
            val headline = nativeAd.headline
            primaryView.text = headline

            var iconView: ImageView? = null
            iconView = findViewById<ImageView>(R.id.icon_small)
