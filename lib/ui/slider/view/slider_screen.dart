                    ...
                    return Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          width: Get.width,
                          child: Image.asset(
                            "assets/images/ic_bank.png" /*,height: Get.height * 0.02*/,
                            // fit: BoxFit.fill,
                          ),
                          // child: Image.network(logic.sliderData[index].desc.toString()),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(logic.sliderData[index].desc.toString()),
                        ),
                      ],
                    );
                  },
